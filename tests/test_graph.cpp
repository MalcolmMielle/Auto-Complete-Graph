...
void prior(AASS::acg::AutoCompleteGraph& acg){
	...
	g2o::EdgeSE2Prior_malcolm* wall0 = acg.addEdgePrior(priorse21, prior0, prior1);
	g2o::EdgeSE2Prior_malcolm* wall1 = acg.addEdgePrior(priorse21, prior1, prior2);
	
	auto land0 = acg.getGraph().vertex(0);
	auto land1 = acg.getGraph().vertex(1);
	auto land2 = acg.getGraph().vertex(2);
...
void robotGraph(AASS::acg::AutoCompleteGraph& acg){
	...
	g2o::SE2 rpose(0, 0, 0);
	auto robot0 = acg.addRobotPose(rpose);
	robot0->setId(6);
	g2o::SE2 rpose2(0, 1, 0);
	auto robot1 = acg.addRobotPose(rpose2);
	robot1->setId(7);
	g2o::SE2 rpose3(0, 2, 0);
	auto robot2 = acg.addRobotPose(rpose3);
	robot2->setId(8);
	
	auto odo0 = acg.addOdometry(rpose2, robot0, robot1);
	auto odo1 = acg.addOdometry(rpose2, robot1, robot2);
	
	Eigen::Vector2d vec; vec << 0, 0;
	auto obs1 = acg.addLandmarkObservation(vec, 6, 0);
	Eigen::Vector2d vec2; vec2 << 1, -0.5;
