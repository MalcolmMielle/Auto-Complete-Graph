...
AASS::acg::EdgeLandmark_malcolm* AASS::acg::AutoCompleteGraph::addLandmarkObservation(const g2o::Vector2& pos, g2o::HyperGraph::Vertex* v1, g2o::HyperGraph::Vertex* v2){
...
AASS::acg::EdgeLandmark_malcolm* AASS::acg::AutoCompleteGraph::addLandmarkObservation(const g2o::Vector2& pos, int from_id, int toward_id){
	g2o::HyperGraph::Vertex* from_ptr = _optimizable_graph.vertex(from_id);
	g2o::HyperGraph::Vertex* toward_ptr = _optimizable_graph.vertex(toward_id);
...
AASS::acg::EdgeLinkXY_malcolm* AASS::acg::AutoCompleteGraph::addLinkBetweenMaps(const g2o::Vector2& pos, g2o::VertexSE2Prior* v2, g2o::VertexLandmarkNDT* v1){
...
// 	//Prior
// 	EdgeLandmark_malcolm* ptr = dynamic_cast<EdgeLandmark_malcolm*>(v1);
// 	AASS::acg::EdgeSE2Prior_malcolm* ptr_se2 = dynamic_cast<AASS::acg::EdgeSE2Prior_malcolm*>(v1);
// 	EdgeOdometry_malcolm* ptr_se3 = dynamic_cast<EdgeOdometry_malcolm*>(v1);
//
// 	if(ptr != NULL){
// 		int index = findPriorNode(v1);
// 		assert(index != -1);
...
bool AASS::acg::AutoCompleteGraph::linkAlreadyExist(g2o::VertexLandmarkNDT* v_pt, g2o::VertexSE2Prior* v_prior, std::vector <EdgeLinkXY_malcolm* >::iterator& it)
{
