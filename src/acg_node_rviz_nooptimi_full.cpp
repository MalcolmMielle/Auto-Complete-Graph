...
void gotGraphandOptimize(const ndt_feature::NDTGraphMsg::ConstPtr msg,
    ...
    std::string file_outg =
        "/home/malcolm/ACG_folder/ACG_RVIZ_SMALL_NOOPTIMI/"
        "occupancygrid_full_nooptimi_";
    ...
    std::string file_outg_partial =
        "/home/malcolm/ACG_folder/ACG_RVIZ_SMALL_NOOPTIMI/"
        "occupancygrid_full_partial_nooptimi_";
...
int main(int argc, char** argv) {
    ...
    // 		Eigen::Vector2d(0.0005, 0.0001), //Robot translation noise
    // 		DEG2RAD(2.), 				//Rotation noise for
    // robot 		Eigen::Vector2d(0.5, 0.5), //Landmarks noise
    // Eigen::Vector2d(1, 0.01), //Prior noise 		DEG2RAD(2.), //Prior rot
    ...
    visu.setImageFileNameOut(
        "/home/malcolm/ACG_folder/ACG_RVIZ_SMALL/Noopitimization_rviz_small");
