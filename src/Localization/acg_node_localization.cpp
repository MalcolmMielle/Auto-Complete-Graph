...
bool exportErrorNoiseOdometry(const AASS::acg::AutoCompleteGraphLocalization &oacg)
{
	...
	infile << std::endl
		   << "# number_of_nodes mean_error_translation std mean_error_translation_noisy std mean_error_gt std mean_error_angle std mean_error_angle_noisy std mean_error_angle_gt std" << std::endl;
