...
g2o::EdgeXYPriorACG* AASS::acg::AutoCompleteGraphPriorXY::addEdge(
    const g2o::SE2& se2,
...
g2o::VertexXYPrior* AASS::acg::AutoCompleteGraphPriorXY::addPose(
    const g2o::SE2& se2,
...
int AASS::acg::AutoCompleteGraphPriorXY::addPriorGraph(
...
void AASS::acg::AutoCompleteGraphPriorXY::updatePriorEdgeCovariance() {
    ...
    for (it; it != edges.end(); ++it) {
        g2o::VertexXYPrior* v_ptr =
            dynamic_cast<g2o::VertexXYPrior*>((*it)->vertices()[0]);
        if (v_ptr == NULL) {
            throw std::runtime_error("no");
        }
        g2o::VertexXYPrior* v_ptr2 =
            dynamic_cast<g2o::VertexXYPrior*>((*it)->vertices()[1]);
        if (v_ptr2 == NULL) {
...
void AASS::acg::AutoCompleteGraphPriorXY::testNoNanInPrior(
    ...
    for (it_edge; it_edge != edges.end(); ++it_edge) {
        g2o::VertexXYPrior* v_ptr =
            dynamic_cast<g2o::VertexXYPrior*>((*it_edge)->vertices()[0]);
        if (v_ptr == NULL) {
            throw std::runtime_error("no");
        }
        g2o::VertexXYPrior* v_ptr2 =
            dynamic_cast<g2o::VertexXYPrior*>((*it_edge)->vertices()[1]);
        if (v_ptr2 == NULL) {
            throw std::runtime_error("no2");
        }
        Eigen::Vector2d pose1 = v_ptr->estimate();
...
AASS::acg::AutoCompleteGraphPriorXY::toPointCloud(double resolution,
                                                  double z_elevation,
                                                  double varz) const {
