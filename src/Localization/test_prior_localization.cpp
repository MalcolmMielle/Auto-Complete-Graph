...
int main()
{
	...
	mahalanobis_distance = (pose_prior - pose_landmark).dot(cov_inv_2d.inverse() * (pose_prior - pose_landmark));
	pdf_collision = factor * std::exp(-mahalanobis_distance / 2);
	std::cout << "distance: " << 4 << " l: " << l << " score : " << score << " l should be smaller here than before "
	...
	mahalanobis_distance = (pose_prior - pose_landmark).dot(cov_inv_2d.inverse() * (pose_prior - pose_landmark));
	pdf_collision = factor * std::exp(-mahalanobis_distance / 2);
	std::cout << "distance: " << 4 << " l: " << l << " score : " << score << " l with rotation "
			  << " pdf " << pdf_collision << std::endl;
	...
	mahalanobis_distance = (pose_prior - pose_landmark).dot(cov_inv_2d.inverse() * (pose_prior - pose_landmark));
	pdf_collision = factor * std::exp(-mahalanobis_distance / 2);
	std::cout << "distance: " << 4 << " l: " << l << " score : " << score << " l with rotation should be smaller "
			  << " pdf " << pdf_collision << std::endl;
	...
	mahalanobis_distance = (pose_prior - pose_landmark).dot(cov_inv_2d.inverse() * (pose_prior - pose_landmark));
	pdf_collision = factor * std::exp(-mahalanobis_distance / 2);
	std::cout << "distance: " << 4 << " l: " << l << " score : " << score << " l with rotation should be even smaller "
			  << " pdf " << pdf_collision << std::endl;
	...
	mahalanobis_distance = (pose_prior - pose_landmark).dot(cov_inv_2d.inverse() * (pose_prior - pose_landmark));
	pdf_collision = factor * std::exp(-mahalanobis_distance / 2);
	std::cout << "distance: " << 4 << " l: " << l << " score : " << score << " l with rotation should be even even smaller "
			  << " pdf " << pdf_collision << std::endl;
}