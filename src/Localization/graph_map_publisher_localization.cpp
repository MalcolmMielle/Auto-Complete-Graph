...
public:
	...
	Eigen::Affine3d getAsAffine(float x, float y, float yaw)
	{
		...
		m = Eigen::AngleAxisd(0, Eigen::Vector3d::UnitX()) * Eigen::AngleAxisd(0, Eigen::Vector3d::UnitY()) * Eigen::AngleAxisd(yaw, Eigen::Vector3d::UnitZ());
	...
	void points2OdomCallbackTF(const sensor_msgs::PointCloud2::ConstPtr &msg_in)
