...
g2o::EdgeSE2Prior_malcolm* AASS::acg::AutoCompleteGraphPriorSE2::addEdge(const g2o::SE2& se2, g2o::HyperGraph::Vertex* v1, g2o::HyperGraph::Vertex* v2){
...
g2o::VertexSE2Prior* AASS::acg::AutoCompleteGraphPriorSE2::addPose(const g2o::SE2& se2, const PriorAttr& priorAttr, int index){
...
g2o::VertexSE2Prior* AASS::acg::AutoCompleteGraphPriorSE2::addPose(const Eigen::Vector3d& lan, const PriorAttr& priorAttr, int index){
	g2o::SE2 se2(lan(0), lan(1), lan(2));
	return addPose(se2, priorAttr, index);
}
g2o::VertexSE2Prior* AASS::acg::AutoCompleteGraphPriorSE2::addPose(double x, double y, double theta, const AASS::acg::PriorAttr& priorAttr, int index){
	Eigen::Vector3d lan;
	lan << x, y, theta;
...
// 		std::cout << "Prior Landmark : " << graph[v].getX() << " " << graph[v].getY() << std::endl;
		...
		g2o::VertexSE2Prior* res = addPose(graph[v].getX(), graph[v].getY(), 0, graph[v], first_index);
		first_index++;
...
pcl::PointCloud<pcl::PointXYZ>::Ptr AASS::acg::AutoCompleteGraphPriorSE2::toPointCloud(double resolution, double z_elevation, double varz) const {
