...
Eigen::Vector2d g2o::EdgeSE2Prior_malcolm::getOrientation2D(
    const g2o::VertexSE2Prior& from) const {
    // 	std::cout << "From " << from.estimate().toVector();
    g2o::VertexSE2Prior* ptr =
        dynamic_cast<g2o::VertexSE2Prior*>(this->vertices()[0]);
    g2o::VertexSE2Prior* ptr2 =
        dynamic_cast<g2o::VertexSE2Prior*>(this->vertices()[1]);
    assert(ptr != NULL);
    assert(ptr2 != NULL);
    ...
    pose_prior << pose_from1(0), pose_from1(1);
    return pose_prior;
}