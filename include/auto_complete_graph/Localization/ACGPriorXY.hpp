 ...
 */
class AutoCompleteGraphPriorXY
    : public AutoCompleteGraphPrior<g2o::VertexXYPrior, g2o::EdgeXYPriorACG> {
   public:
    AutoCompleteGraphPriorXY(const Eigen::Vector2d& pn,
                             double rp,
                             const g2o::SE2& sensoffset)
        : AutoCompleteGraphPrior(pn, rp, sensoffset) {}
    AutoCompleteGraphPriorXY(const g2o::SE2& sensoffset)
        : AutoCompleteGraphPrior(sensoffset) {}

    virtual g2o::VertexXYPrior* addPose(const g2o::SE2& se2,
                                        const PriorAttr& priorAttr,
                                        int index);
    virtual g2o::VertexXYPrior* addPose(const Eigen::Vector3d& lan,
                                        const PriorAttr& priorAttr,
                                        int index);
    virtual g2o::VertexXYPrior* addPose(double x,
                                        double y,
                                        double theta,
                                        const PriorAttr& priorAttr,
                                        int index);

    virtual g2o::EdgeXYPriorACG* addEdge(const g2o::SE2& se2,
    ...
    pcl::PointCloud<pcl::PointXYZ>::Ptr toPointCloud(double resolution,
                                                     double z_elevation,
                                                     double varz) const;
};
}  // namespace acg
