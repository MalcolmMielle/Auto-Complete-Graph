 ...
 */
class AutoCompleteGraphPriorSE2
    : public AutoCompleteGraphPrior<g2o::VertexSE2Prior,
                                    g2o::EdgeSE2Prior_malcolm> {
   protected:
   public:
    AutoCompleteGraphPriorSE2(const Eigen::Vector2d& pn,
                              double rp,
                              const g2o::SE2& sensoffset)
        : AutoCompleteGraphPrior(pn, rp, sensoffset) {}
    AutoCompleteGraphPriorSE2(const g2o::SE2& sensoffset)
        : AutoCompleteGraphPrior(sensoffset) {}

    virtual g2o::VertexSE2Prior* addPose(const g2o::SE2& se2,
                                         const PriorAttr& priorAttr,
                                         int index);
    virtual g2o::VertexSE2Prior* addPose(const Eigen::Vector3d& lan,
                                         const PriorAttr& priorAttr,
                                         int index);
    virtual g2o::VertexSE2Prior* addPose(double x,
                                         double y,
                                         double theta,
                                         const PriorAttr& priorAttr,
                                         int index);

    virtual g2o::EdgeSE2Prior_malcolm* addEdge(const g2o::SE2& se2,
    ...
    virtual pcl::PointCloud<pcl::PointXYZ>::Ptr toPointCloud(double resolution,
                                                             double z_elevation,
                                                             double varz) const;
};
}  // namespace acg
