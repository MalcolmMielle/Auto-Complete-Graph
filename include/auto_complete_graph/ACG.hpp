	...
	namespace acg
	{
		...
		public:
			AutoCompleteGraph(const g2o::SE2 &sensoffset,
							  ...
							  ndt_feature::NDTFeatureGraph *ndt_graph) : _min_distance_for_link_in_meter(1), _max_distance_for_link_in_meter(2), _use_links_prior(true), _linkNoise(linkn), AutoCompleteGraphBase<AutoCompleteGraphPriorSE2, g2o::VertexSE2Prior, g2o::EdgeSE2Prior_malcolm>(sensoffset, tn, rn, ln, pn, rp, ndt_graph) {}
			...
			AutoCompleteGraph(const g2o::SE2 &sensoffset,
							  ...
							  const Eigen::Vector2d &pn,
							  double rp,
							  const Eigen::Vector2d &linkn) : _min_distance_for_link_in_meter(1), _max_distance_for_link_in_meter(2), _use_links_prior(true), _linkNoise(linkn), AutoCompleteGraphBase<AutoCompleteGraphPriorSE2, g2o::VertexSE2Prior, g2o::EdgeSE2Prior_malcolm>(sensoffset, tn, rn, ln, pn, rp) {}
