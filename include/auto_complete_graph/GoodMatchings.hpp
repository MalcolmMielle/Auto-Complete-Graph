...
class GoodMatchings : public RvizPoints {
   public:
    GoodMatchings(ros::NodeHandle nh, AutoCompleteGraph* acg)
        : RvizPoints(nh, acg) {}
    ...
    void getOutliers() {
        ...
        std::cout << "/********************************************************"
                     "**********/"
                  << std::endl;
        std::cout << "outliers : " << all - good << " with " << good
                  << " good links" << std::endl;
        std::cout << "/********************************************************"
                     "**********/"
                  << std::endl;
